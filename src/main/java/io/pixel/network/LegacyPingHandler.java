...
public class LegacyPingHandler extends ChannelInboundHandlerAdapter {
    ...
    public LegacyPingHandler(NetworkServer network) {
            ...
            if (bytebuf.readUnsignedByte() == 254) {
                ...
                switch (i) {
                    case 0:
                        ...
                        String s2 = String.format("%s\u00a7%d\u00a7%d", this.network.server.getConfig().getMotd(), 1, 1);
                    ...
                    case 1:
                        ...
                        String s = String.format("\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", Integer.valueOf(127), this.network.server.getConfig().getMinecraftVersion(), this.network.server.getConfig().getMotd(), 1, 1);
                    ...
                    default:
                        ...
                        String s1 = String.format("\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", Integer.valueOf(127), this.network.server.getConfig().getMinecraftVersion(), this.network.server.getConfig().getMotd(), 1, 1);
